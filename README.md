...
```
cd existing_repo
git remote add origin https://gitlab.isima.fr/anboudoul/orchezz.git
git branch -M master
...
* [Set up project integrations](https://gitlab.isima.fr/anboudoul/orchezz/-/settings/integrations)
